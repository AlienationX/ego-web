    ...
    <view class="layout">
        ...
        <scroll-view scroll-y class="content" :style="{ height: contentHeight }">
            ...
            <text class="app-version"
                >{{ t('settings1.version') }} {{ APP_INFO.appVersion || '2.4.1' }} · {{ t('settings1.build') }}
                {{ APP_INFO.appVersionCode || '1082' }}</text
            >
        </scroll-view>
...
const profileName = computed(
    () => userStore.userinfo?.profile?.nickname || userStore.userinfo?.nickname || t('settings1.defaultName'),
);
const profileEmail = computed(() => userStore.userinfo?.email || 'sarah.mitchell@company.com');
    ...
    },
    {
        ...
        items: [
            ...
            },
            {
                ...
                value:
                    settingsStore.options.theme === 'light'
                        ? t('settings1.items.theme.light')
                        : t('settings1.items.theme.dark'),
                action: switchTheme,
            },
            {
                key: 'preview_type',
        ...
        items: [
            {
                ...
                action: () => uni.navigateTo({ url: '/pages/help-centre/help-centre' }),
            },
            {
                key: 'contact_support',
                ...
                action: () => uni.navigateTo({ url: '/pages/feedback/feedback' }),
            },
            {
                key: 'send_feedback',
                icon: 'paperplane-filled',
        ...
        items: [
            {
                ...
                destructive: true,
                action: () => uni.navigateTo({ url: '/pages/logout/logout' }),
            },
            {
                key: 'deactivate',
                icon: 'person-filled',
...
function goBack() {
    uni.navigateBack({
        fail: () => uni.reLaunch({ url: '/pages/test/test' }),
    });
}
