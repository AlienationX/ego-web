<template>
    <view :class="['layout', isDark ? 'theme-dark' : 'theme-light']">
            ...
            <view class="container">
                ...
                <view class="vip-header">
                    ...
                    <view class="user-status">
                        <view class="avatar-box">
                            <image
                                class="avatar"
                                :src="userStore.userinfo?.profile?.avatar || '/static/images/pics/default_avatar.svg'"
                                mode="aspectFill"
                            ></image>
                        ...
                        <view class="info">
                            ...
                            <view class="sub-welcome">
                                {{
                                    userStore.isVip
                                        ? '您的会员有效期至 ' + userStore.vipExpireTime
                                        : '开通超级会员，尊享百万无水印原图'
                                }}
                            </view>
                        </view>
                ...
                <scroll-view scroll-x class="cards-scroll-view" :show-scrollbar="false">
                    <view class="cards-container">
                        ...
                        >
                            ...
                            <view class="old-price" v-if="card.originalPrice"> 原价 ¥{{ card.originalPrice }} </view>
                ...
                <view class="trust-container">
                    ...
                    <view class="trust-icons">
                        <view class="t-item"
                            ><uni-icons type="checkbox-filled" size="16" color="#34d399"></uni-icons><text>官方认证</text></view
                        >
                        <view class="t-item"
                            ><uni-icons type="checkbox-filled" size="16" color="#34d399"></uni-icons><text>隐私保护</text></view
                        >
                        <view class="t-item"
                            ><uni-icons type="checkbox-filled" size="16" color="#34d399"></uni-icons><text>售后无忧</text></view
                        >
                    </view>
                </view>
        ...
        <view class="purchase-footer">
            <view class="agreement-tip"> 开通即视为同意 <text class="link">《会员服务协议》</text> </view>
            <view class="purchase-action">
                <view class="amount-display">
                    <text class="lbl">合计:</text>
                    <text class="val">¥{{ currentCardPrice }}</text>
                </view>
                <button class="purchase-btn" :disabled="selectedCard === null" @click="handlePurchase">
...
.membership-card {
    ...
    &.selected {
        ...
        .selected-aura {
            ...
            inset: -4rpx;
            border-radius: 36rpx;
            box-shadow: 0 0 24rpx rgba(59, 130, 246, 0.3);
            pointer-events: none;
        }
    }
    ...
    .recommend-tag {
        ...
        .shimmer {
            ...
            animation: tag-shimmer 2.5s infinite running;
        }
    }
...
.purchase-footer {
    ...
    border-top: 2rpx solid var(--footer-border);
    display: flex;
    flex-direction: column;
    gap: 16rpx;
    ...
    .purchase-action {
        ...
        .purchase-btn {
            ...
            &:active:not([disabled]) {
                ...
                box-shadow: 0 8rpx 16rpx -6rpx rgba(59, 130, 246, 0.4);
            }
        }
    }
}
