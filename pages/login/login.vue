    ...
    <view class="layout">
        ...
        <view class="container">
            ...
            <view class="tab-wrapper">
                <view class="tab-item" :class="{ active: isLogin }" @click="switchToLogin">
                    <text class="tab-text">{{ t('login.login') }}</text>
                    <view class="tab-indicator" v-if="isLogin"></view>
                </view>
                <view class="tab-item" :class="{ active: !isLogin }" @click="switchToRegister">
                ...
                <view class="form-item">
                    <view class="input-wrapper">
                        ...
                        <view class="password-toggle" @click="togglePasswordVisibility('login')">
                            <uni-icons :type="showLoginPassword ? 'eye-slash' : 'eye'" size="20" color="#999"></uni-icons>
                        </view>
                    </view>
                </view>
                ...
                <view class="form-item">
                    <view class="input-wrapper">
                        ...
                        <view class="password-toggle" @click="togglePasswordVisibility('register')">
                            <uni-icons :type="showRegisterPassword ? 'eye-slash' : 'eye'" size="20" color="#999"></uni-icons>
                        </view>
                    </view>
...
const handleRegister = async () => {
    ...
    try {
        ...
        uni.showToast({
            title: t('login.registerSuccessAndLoggedIn'),
            icon: 'none',
        });
